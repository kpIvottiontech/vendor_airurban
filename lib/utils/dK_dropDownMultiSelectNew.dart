...
///
///
class DropDownMultiSelectNew<T> extends StatefulWidget {
...
class _DropDownMultiSelectState<TState> extends State<DropDownMultiSelectNew<TState>> {
  @override
  Widget build(BuildContext context) {
    return Container(
